// app.js - Versione aggiornata che utilizza PapaParse per il parsing dei CSV
let coefficients = {};
let expenses = {};
 ...
 * Se l'importo è inferiore al valore minimo presente, utilizza il coefficiente associato al valore minimo.
...
function getCoefficientForAmount(amount, duration) {
  ...
  // Se l'importo è inferiore al minimo, usa il coefficiente della chiave più piccola
...
function calculateRent() {
  ...
  // Seleziona le spese di contratto relative: sceglie il range più adeguato
